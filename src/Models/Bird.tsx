...
import { Mesh, AnimationClip } from "three"; // 1. Added Mesh import
...
export default function Bird() {
  ...
  const gltf = useGLTF(birdScene) as any;
  const { scene, animations } = gltf;
  const { actions } = useAnimations(animations as AnimationClip[], birdRef);
